...
public class LockerOLD
{
    ...
    public String getCombination()
    {
        ...
        return "what in the ever-loving-"; // fun way to get intellij to stop throwing a fit over potential lack of return (it will ALWAYS return something else or error out for other reasons)
    }
